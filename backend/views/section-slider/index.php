...
/** @var common\models\SectionSliderSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Section Slider';
...
//                        'id',
            ...
            [
                'attribute'=>'image',
                'value'=>function($data){
                    $image = \common\components\StaticFunctions::getImage($data->image,'section-slider',$data->id);
