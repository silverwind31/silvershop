    ...
    <nav class="breadcrumb-nav mb-10">
        <div class="container">
            <ul class="breadcrumb py-4">
                ...
                <li><a href="<?=\yii\helpers\Url::to(['/user/profile'])?>">My account</a></li>
                <li>Wishlist</li>
            </ul>
        </div>
    </nav>
                ...
                <tr>
                    <td class="product-thumbnail">
                        <div class="p-relative">
                            <a href="<?=\yii\helpers\Url::to(['/product/view'])?>">
                                <figure>
                                    <img src="/images/shop/19-1.jpg" alt="product" width="300"
                                         height="338">
                                </figure>
                            </a>
                            <button type="submit" class="btn btn-close"><i
                    ...
                    <td class="product-thumbnail">
                        <div class="p-relative">
                            <a href="product-default.html">
                                <figure>
                                    <img src="/images/shop/20.jpg" alt="product" width="300"
                                         height="338">
                                </figure>
                            </a>
                            <button type="submit" class="btn btn-close"><i
